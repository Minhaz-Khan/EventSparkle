  ...
  return (
    <div className="my-10 ">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 md:grid-cols-2 my-8  gap-4">
        <div className="md:my-4 my-2 xl:my-4 lg:my-4 md:flex xl:flex lg:flex md:text-left xl:text-left lg:text-left text-center">
          ...
          <div>
            ...
            <p className="text-xl">Apparently we had reached a great height in the atmosphere.</p>
          </div>
        </div>
        {/* 2 */}
        <div className="md:my-4 my-2 xl:my-4 lg:my-4 md:flex xl:flex lg:flex md:text-left xl:text-left lg:text-left text-center">
